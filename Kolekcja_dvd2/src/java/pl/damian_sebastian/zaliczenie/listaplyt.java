...
@WebServlet(name = "listaplyt", urlPatterns = {"/listaplyt"})
public class listaplyt extends HttpServlet {
    public void doPost( HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
      ...
      try
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM kolekcja");               
         out.println("<center><h1> Lista płyt DVD </h><br> <br>");                                                                                
         out.println("<table border=1>"); 
         out.println("<thead><tr><th> Lp. </th><th> Tytuł </th><th> Opis </th><th>Gatunek<th>Rok</tr></tr></thead>");
         while (rs.next())                                                                                  
         {                                                                                                  
            out.println("<thead><tr><th>"+rs.getInt(1)+"</th><th>"+rs.getString(2)+"</th><th>"+rs.getString(3)+"</th><th>"+rs.getString(4)+"<th>"+rs.getString(5)+"</tr></tr></thead>");                   
